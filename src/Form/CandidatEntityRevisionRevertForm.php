...
/**
 * Provides a form for reverting a Candidat entity revision.
 *
 * @ingroup candidat_vote
 */
class CandidatEntityRevisionRevertForm extends ConfirmFormBase {
  ...
  public function getFormId() {
    return 'candidat_entity_revision_revert_confirm';
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->logger('content')->notice('Candidat entity: reverted %title revision %revision.', ['%title' => $this->revision->label(), '%revision' => $this->revision->getRevisionId()]);
    $this->messenger()->addMessage(t('Candidat entity %title has been reverted to the revision from %revision-date.', ['%title' => $this->revision->label(), '%revision-date' => $this->dateFormatter->format($original_revision_timestamp)]));
   ...
   *
   * @param \Drupal\candidat_vote\Entity\CandidatEntityInterface $revision
   ...
   */
  protected function prepareRevertedRevision(CandidatEntityInterface $revision, FormStateInterface $form_state) {
